...
/******************************************************************************
* The <CODE>Autolavado</CODE> Java application illustrates the use of
* the <CODE>AutolavadoSimulate</CODE> method.
...
*   <A HREF="../applications/Autolavado.java">
*   http://www.cs.colorado.edu/~main/applications/Autolavado.java
*   </A>
*
*  
...
{
   /**
   * The main method activates <CODE>AutolavadoSimulate</CODE> with the values:
   *   <CODE>
   *   <br>washTime = 240
   *   <br>arrivalTime = 0.0025
   *   <br>totalTime = 6000
   ...
   **/
   public static void main(String[ ] args)
   {
      ...
      AutolavadoSimulate(WASHTIME, ARRIVALPROB, TOTALTIME);
   }
       
     public static void AutolavadoSimulate
